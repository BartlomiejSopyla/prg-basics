...
# that is, whether the person has at least two of the following accounts: Facebook, 
# Twitter or Instagram. Use logical type variables: facebook, twitter, instagram, 
...
twitter = False
instagram = True
combined = facebook + twitter + instagram
